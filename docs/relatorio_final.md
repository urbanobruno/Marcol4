...
## 3.3.6 Processo 6 – CANCELAMENTO

O processo de cancelamento é responsável por retirar um time de uma vaga na qual o mesmo já se cadastrou, onde o sistema deve verificar os participantes da vaga, realizar a retirada do time que deseja sair e atualizar os status da vaga. Após a efetuação do cancelamento, o time será notificado sobre a sua exclusão da vaga e a vaga voltara para a lista de vagas disponíveis.

![Modelo BPMN do processo 6](imagens/new-bpmn-diagram.png "Modelo BPMN do Processo 6.")

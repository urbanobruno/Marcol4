...
const dadosIniciais = {
  usuarios: [
    { "id": generateUUID(),  "senha": "123", "nome": "Administrador do Sistema", "email": "admin@abc.com", "clube_id": 1 },
    { "id": generateUUID(),  "senha": "123", "nome": "Usuario Comum", "email": "user@abc.com", "clube_id": 2 },
  ]
};
...
// buttonSubmit.addEventListener('click', (e) => addUser(e));
